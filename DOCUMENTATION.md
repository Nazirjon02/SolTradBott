...
- **Сканировать новые мемкоины** — DexScreener boosts/profiles + фильтры (ликвидность, MC, возраст).
...
Быстрый вход по всплеску объёма (≥2× среднего) и импульсу за 5 минут. Trailing + break-even включены, time-stop 60 минут.
