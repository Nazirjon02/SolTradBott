...
/**
 * Momentum Scalping — быстрый вход по всплеску объёма и импульсу
 ...
 *  2) импульс: рост за 5 минут > 0 и последние свечи преимущественно зелёные.
 */
class MomentumStrategy(override val config: StrategyConfig) : Strategy {
    ...
    override suspend fun analyze(
        ...
        // 2. Импульс: рост 5м + зелёные свечи
        ...
        val confidence = (0.5 + 0.3 * volumeScore + 0.2 * greenScore).coerceAtMost(0.95)
        ...
        return Signal(
            ...
            reason = "Momentum: объём ×${fmt(lastVolume / avgVolume)}, " +
